public class ArrayDeque<T>{
    ...
    /** Return the real index in the array given the nominal index (nominal index might exceed the length of the array)
     *
    ...
    private int realIndex(int nominalIndex, int arrayLength){
        return nominalIndex % arrayLength;
    }
    ...
    public ArrayDeque(ArrayDeque other){
        ...
        int i = 0;
        while (i < this.size){
            this.items[realIndex(firstIndex + i, this.items.length)] = (T) other.items[realIndex(firstIndex + i, other.items.length)];
        }
    }
